...
""" get_randomly_spread_cities(size, n_ciites)
...
""" get_routes(city_names)
Takes a list of cities and returns a list of all possible routes between those cities. 
...
#main method (for testing cities_n_routes, otherwise not used)
